...
- Interfaces, es decir, las diferentes plataformas través de las cuales los usuarios pueden acceder a Metasploit Framework:
...
- Bibliotecas, que contienen las diferentes funciones de Metasploit Framework que permiten a los usuarios ejecutar exploits sin escribir código adicional:
...
- Módulos, que se utilizan para realizar tareas como escaneos y explotación de objetivos:
...
- Complementos, los cuales amplian la funcionalidad de todo el framework
